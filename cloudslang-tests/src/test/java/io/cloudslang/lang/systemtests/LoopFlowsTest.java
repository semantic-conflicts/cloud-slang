...
public class LoopFlowsTest extends SystemsTestsParent {
  @Test public void testFlowWithLoops() throws Exception {
  ...
  @Test public void testFlowWithLoopsWithCustomNavigation() throws Exception {
  ...
  @Test public void testFlowWithLoopsWithDefaultBreak() throws Exception {
  ...
  @Test public void testFlowWithLoopsWithEmptyBreak() throws Exception {
  ...
  @Test public void testFlowWithLoopsWithBreak() throws Exception {
  ...
  @Test public void testFlowWithMapLoops() throws Exception {
  ...
  @Test public void testFlowWithHashMap() throws Exception {
  ...
  @Test public void testFlowWithMapLoopsWithCustomNavigation() throws Exception {
  ...
  @Test public void testFlowWithMapLoopsWithDefaultBreak() throws Exception {
  ...
  @Test public void testFlowWithMapLoopsWithEmptyBreak() throws Exception {
  ...
  @Test public void testFlowWithMapLoopsWithBreak() throws Exception {
  ...
  public List<String> getTasksOnly(  Map<String,StepData> stepsData){
    return filter(not(endsWith("0")),stepsData.keySet());
  }
  public void verifyPersonMap(  Map<String,StepData> stepsData){
    StepData firstTask=stepsData.get(FIRST_STEP_PATH);
    StepData secondTask=stepsData.get(SECOND_STEP_KEY);
    StepData thirdTask=stepsData.get(THIRD_STEP_KEY);
    @SuppressWarnings("unchecked") Set<Map<String,Serializable>> actualContextSet=Sets.newHashSet(firstTask.getInputs(),secondTask.getInputs(),thirdTask.getInputs());
    ...
    @SuppressWarnings("unchecked") Set<Map<String,Serializable>> expectedContextSet=Sets.newHashSet(context1,context2,context3);
    Assert.assertEquals("loop task inputs not as expected",expectedContextSet,actualContextSet);
  }
  public LoopFlowsTest(){
  }
}
