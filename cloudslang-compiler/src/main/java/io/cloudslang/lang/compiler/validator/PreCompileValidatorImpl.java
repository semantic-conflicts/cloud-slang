...
@Component public class PreCompileValidatorImpl extends AbstractValidator implements PreCompileValidator {
  ...
  @Override public void validateResultsSection(  Map<String,Object> executableRawData,  String artifact,  List<RuntimeException> errors){
  ...
  @Override public void validateNoDuplicateInOutParams(  List<? extends InOutParam> inputs,  InOutParam element){
  ...
  @Override public void validateStringValue(  String name,  Serializable value,  InOutTransformer transformer){
  ...
  public String getMessagePart(  Class aClass){
    String messagePart="";
  ...
  public void validateNotDuplicateInOutParam(  Collection<InOutParam> inOutParams,  InOutParam element,  String message){
