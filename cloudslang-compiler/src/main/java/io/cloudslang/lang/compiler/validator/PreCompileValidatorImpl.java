...
/** 
 * User: bancl Date: 6/17/2016
 */
@Component public class PreCompileValidatorImpl extends AbstractValidator implements PreCompileValidator {
  public static String MULTIPLE_ON_FAILURE_MESSAGE_SUFFIX="Multiple 'on_failure' steps found";
  public static String ON_FAILURE_LAST_STEP_MESSAGE_SUFFIX="'on_failure' should be last step in the workflow";
  public static String FLOW_RESULTS_WITH_EXPRESSIONS_MESSAGE="Explicit values are not allowed for flow results. Correct format is:";
  @Override public String validateExecutableRawData(  ParsedSlang parsedSlang,  Map<String,Object> executableRawData,  List<RuntimeException> errors){
  ...
  @Override public List<Map<String,Map<String,Object>>> validateWorkflowRawData(  ParsedSlang parsedSlang,  Map<String,Object> executableRawData,  List<RuntimeException> errors){
    String executableName=getExecutableName(executableRawData);
  ...
  @Override public ExecutableModellingResult validateResult(  ParsedSlang parsedSlang,  Map<String,Object> executableRawData,  ExecutableModellingResult result){
    String executableName=getExecutableName(executableRawData);
  ...
  @Override public List<RuntimeException> checkKeyWords(  String dataLogicalName,  String parentProperty,  Map<String,Object> rawData,  List<Transformer> allRelevantTransformers,  List<String> additionalValidKeyWords,  List<List<String>> constraintGroups){
  ...
  @Override public Map<String,Map<String,Object>> validateOnFailurePosition(  List<Map<String,Map<String,Object>>> workFlowRawData,  String execName,  List<RuntimeException> errors){
  ...
  @Override public void validateDecisionResultsSection(  Map<String,Object> executableRawData,  String artifact,  List<RuntimeException> errors){
  ...
  @Override public List<RuntimeException> validateNoDuplicateInOutParams(  List<? extends InOutParam> inputs,  InOutParam element){
    List<RuntimeException> errors=new ArrayList<>();
  ...
  @Override public void validateResultsHaveNoExpression(  List<Result> results,  String artifactName,  List<RuntimeException> errors){
  ...
  @Override public void validateResultTypes(  List<Result> results,  String artifactName,  List<RuntimeException> errors){
    for (    Result result : results) {
  ...
  @Override public void validateDefaultResult(  List<Result> results,  String artifactName,  List<RuntimeException> errors){
  ...
  public String getMessagePart(  InOutParam element){
    String messagePart="";
  ...
  public void validateFlow(  Flow compiledFlow,  ExecutableModellingResult result){
  ...
  public Set<String> getResultNames(  Flow compiledFlow){
  ...
  public void validateNavigation(  Step currentStep,  Deque<Step> steps,  Set<String> resultNames,  Set<String> reachableStepNames,  Set<String> reachableResultNames,  List<RuntimeException> errors){
  ...
  public boolean isProcessed(  String navigationTarget,  Set<String> reachableStepNames,  Set<String> reachableResultNames){
    return reachableStepNames.contains(navigationTarget) || reachableResultNames.contains(navigationTarget);
  }
  public void validateStepsAreReachable(  Set<String> reachableStepNames,  Deque<Step> steps,  List<RuntimeException> errors){
    for (    Step step : steps) {
  ...
  public void validateResultsAreReachable(  Set<String> reachableResultNames,  Set<String> resultNames,  List<RuntimeException> errors){
  ...
  public void validateNamespace(  ExecutableModellingResult result){
  ...
  public void validateNotDuplicateInOutParam(  Collection<InOutParam> inOutParams,  InOutParam element,  String message,  List<RuntimeException> errors){
  ...
  public PreCompileValidatorImpl(){
  }
}
